<template>
  <main class="flex place-content-center pt-[96px] lg:pt-[72px]">
    <article class="prose max-w-3xl p-12 sm:p-10">
      ...
      <p>
        東京都板橋区生まれ、東京都板橋区育ちのいたばしっ子。実は最近埼玉県民になった。
      ...
      <p>
        ...
        大学では特別支援教育を専攻し、幼稚園・小学校・中学校・高等学校・特別支援学校の教員免許を取得。
      </p>

      <p>
        現在はITエンジニアとして、都内の某IT企業に従事している。
      </p>
      ...
      <section>
        ...
        <ul>
          ...
          <li>埼玉大学 総務部 広報渉外課 埼大学生広報サポーター 第1期～第3期生(2022～2025)</li>
          <li>埼玉大学障がい学生支援室 障がい学生サポーター 第1期生(2024～2025)</li>
          <li>埼玉大学障がい学生支援室 パソコンノートテイカー 第1期生(2024～2025)</li>
      ...
      <section>
        ...
        <table class="table table-lg">
          ...
          <tbody>
            ...
            <tr>
              <td>2025/03</td>
              <td>特別支援学校教諭一種免許状を取得</td>
            </tr>

            <tr>
              <td>2025/03</td>
              <td>中学校教諭一種免許状(英語)を取得</td>
            </tr>

            <tr>
              <td>2025/03</td>
              <td>高等学校教諭一種免許状(英語)を取得</td>
            </tr>
