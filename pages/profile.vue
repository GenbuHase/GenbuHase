<template>
  <main class="flex place-content-center pt-[96px] lg:pt-[72px]">
    <article class="prose max-w-3xl p-12 sm:p-10">
      ...
      <p>
        東京都板橋区生まれ、東京都板橋区育ちのいたばしっ子。
        小学3年生より独学でプログラミングをはじめ、現在もサービスやプロダクトの開発を行っている。
      </p>

      <p>
        高校卒業後は埼玉大学に通い、東京よりも埼玉に入り浸るように。
        青春18きっぷ旅行を利用した一人旅などを通して、少しずつ行動範囲を広げはじめる。
        大学では特別支援教育を専攻し、幼稚園・小学校・中学校・高等学校・特別支援学校の教員免許を取得する見込み。
      </p>

      <section>
        <h2>
          <Icon name="mdi:worker-outline" />
          Roles
        </h2>

        <ul>
          <li>埼玉大学 教育学部 学校教育教員養成課程 特別支援教育コース 4年生</li>
          <li>埼玉大学手話サークル ゆびつむぎ 創設者／第1期・第2期代表(2021～2023)／第3期広報部長(2023～2024)</li>
          <li>埼玉大学メイド部 創設者／代表(2024～2025)</li>
          <li>埼玉大学 総務部 広報渉外課 埼大学生広報サポーター 第1期生(2022～)</li>
          <li>埼玉大学障がい学生支援室 障がい学生サポーター／パソコンノートテイカー(2024～)</li>
          <li>Saidai Contest 2023 準グランプリ(2023)</li>
          <li>MR OF MR CAMPUS CONTEST 2024 出場者(2024)</li>
        </ul>
      </section>

      <section>
        <h2>
          <Icon name="mdi:gear-outline" />
          Skills
        </h2>
      ...
      <section>
        ...
        <table class="table table-lg">
          ...
          <tbody>
            <tr>
              <td>2016/02</td>
              <td>日本漢字能力検定 準2級を取得</td>
            </tr>

            <tr>
              <td>2016/11</td>
              <td>実用英語技能検定 2級を取得</td>
            </tr>

            <tr>
              <td>2018/12</td>
              <td>語彙・読解力検定 2級を取得</td>
            </tr>

            <tr>
              <td>2020/11</td>
              <td>実用英語技能検定 2級を再取得 (2198点)</td>
            </tr>

            <tr>
              <td>2022/02</td>
              <td>TOEIC Listening & Reading Test 770点を取得</td>
            </tr>

            <tr>
              <td>2025/03</td>
              <td>小学校教諭一種免許状を取得見込み</td>
            </tr>

            <tr>
              <td>2025/03</td>
              <td>中学校教諭一種免許状(英語)を取得見込み</td>
            </tr>

            <tr>
              <td>2025/03</td>
              <td>高等学校教諭一種免許状(英語)を取得見込み</td>
            </tr>

            <tr>
              <td>2025/03</td>
              <td>特別支援学校教諭一種免許状を取得見込み</td>
            </tr>

            <tr>
              <td>2025/03</td>
              <td>幼稚園教諭二種免許状を取得見込み</td>
            </tr>
          </tbody>
        </table>
      </section>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            <li><a href="https://www.instagram.com/genbuhase" target="_blank">長谷 玄武 / Genbu Hase (@genbuhase)</a></li>
            <li><a href="https://www.instagram.com/programmergenboo" target="_blank">どっかのげんちゃん。 (@programmergenboo)</a></li>
          </ul>
        </section>
      </section>
    </article>
